...
class IdentifierTests(unittest.TestCase):
    ...
    def test_algol68_separators_are_ignored(self):
        self.assertEqual(
            self.preprocessor.normalize_identifier("my_shape"), "myshape")
        self.assertEqual(
            self.preprocessor.normalize_identifier("my shape"), "myshape")
        self.assertEqual(
            self.preprocessor.normalize_identifier("My_Shape"), "myshape")
    ...
    def test_hash_in_string_is_not_a_comment(self):
        ...
        self.preprocessor.parse_o68(source)
        self.assertEqual(
            self.preprocessor.classes["shape"]["methods"][0]["body"], '"#"')
